        ...
        edges {
          node {
            ...
            childImageSharp {
              ...
              fluid(maxHeight: 300, maxWidth: 250){
          ...
          {Products.map((product) => (
            <div key={product.id} className="product">
              ...
              <div className="product-meta">
                <span className="product-meta__price">
                  &#8358; {product.price}
                </span>
                <span className="product-meta__calories">
                  {product.calories} cal
                </span>
                <button
                  className="product-meta__cart"
                  onClick={() => context.updateCart(product.id)}
                >
                  <svg
                    width="16"
                    height="16"
